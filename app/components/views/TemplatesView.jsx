...
const TemplatesView = ({ user, onNewTemplate, onPreview, onEditTemplate, onUseTemplate, refreshKey }) => {
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-12">
      ...
      <div className="bg-[#2B5E44]/10 dark:bg-[#2B5E44]/20 p-4 rounded-lg border border-[#2B5E44]/20 dark:border-[#2B5E44]/40 flex gap-3 items-center text-sm text-[#2B5E44] dark:text-emerald-300">
        <Info size={18} />
        <p>
      ...
      <div>
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <button
              onClick={onNewTemplate}
              className="flex flex-col items-center justify-center p-8 border-2 border-dashed border-slate-300 dark:border-slate-700 rounded-xl hover:border-[#2B5E44] hover:bg-[#2B5E44]/10 dark:hover:bg-[#2B5E44]/20 transition-all group h-64"
            >
              <div className="w-12 h-12 bg-slate-100 dark:bg-slate-800 rounded-full flex items-center justify-center mb-4 group-hover:bg-[#2B5E44]/15 dark:group-hover:bg-[#2B5E44]/30 transition-colors">
                <Plus size={24} className="text-slate-400 group-hover:text-[#2B5E44] dark:group-hover:text-emerald-300" />
              </div>
              <p className="font-bold text-slate-600 dark:text-slate-300 group-hover:text-[#2B5E44] dark:group-hover:text-emerald-300">New Template</p>
            </button>

            {templates.map((t) => (
              <Card key={t.id} className="flex flex-col h-64 hover:border-[#2B5E44]/30 dark:hover:border-[#2B5E44]/60 transition-colors group relative overflow-hidden">
                <div className="h-2 bg-[#2B5E44] w-full"></div>
                <div className="p-6 flex-1 flex flex-col">
                  <div className="flex justify-between items-start mb-4">
                    <div className="p-2 bg-[#2B5E44]/10 dark:bg-[#2B5E44]/20 rounded-lg">
                      <LayoutTemplate size={20} className="text-[#2B5E44] dark:text-emerald-300" />
                    </div>
                    <button
                      onClick={(e) => {
                        e.stopPropagation();
                ...
                <div className="mt-auto pt-4 border-t border-slate-100 dark:border-slate-700 flex gap-2">
                  <button
                    ...
                    className="flex-1 py-2 text-xs font-bold text-[#2B5E44] bg-[#2B5E44]/10 dark:bg-[#2B5E44]/25 rounded hover:bg-[#2B5E44]/15 transition-colors flex items-center justify-center gap-2"
                  >
                    <Eye size={14} /> Preview
                  </button>
                  <button
              ...
              <div className="p-6 flex-1 flex flex-col">
                ...
                <div className="mt-auto pt-4 border-t border-slate-100 dark:border-slate-700 flex gap-2">
                  ...
                  <button
                    ...
                    className="w-full py-2 text-xs font-bold text-[#2B5E44] bg-[#2B5E44]/10 dark:bg-[#2B5E44]/25 rounded hover:bg-[#2B5E44]/15 transition-colors flex items-center justify-center gap-2 disabled:opacity-60"
                  >
